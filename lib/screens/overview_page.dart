          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text("Total Collectibles this Month"),
                            SizedBox(height: 10),
                            Text(
                ...
                SizedBox(height: 40),
                Text(
                  "This Month's Collections - ${Jiffy.now().format(pattern: 'MMMM')}",
                      ...
                      cells: [
                        ...
                        DataCell(
                          TextButton(
                            ...
                            child: Text(currentMonthPayments[index].clientName),
                          ),
                        ),
                        DataCell(
                          Text(
                          ...
                          TextButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.resolveWith<
                                Color
                              >((Set<WidgetState> states) {
                                if (overduePayments[index].remarks == "Due") {
                                  return Colors.orangeAccent;
                                } else if (overduePayments[index].remarks ==
                                    "Paid") {
                                  return Colors.green;
                                } else if (overduePayments[index].remarks ==
                                    "Overdue") {
                                          ...
                                          if (paymentStatusController.text !=
                                            ...
                                            _databaseHelper.insertBalanceSheet(
                                              Balancesheet(
                                                ...
                                                balanceOUT: 0,
                                                remarks:
                                                    "Partial Payment for ${overduePayments[index].clientName}",
                                                paymentId:
                                                    overduePayments[index]
                                                        .paymentId,
                                              ),
                                            ...
                                            _databaseHelper.insertBalanceSheet(
                                              Balancesheet(
                                                ...
                                                balanceOUT: 0,
                                                remarks:
                                                    "Monthly Payment for ${overduePayments[index].clientName}",
                                                clientId:
                                                    overduePayments[index]
                                                        .clientId,
                                                paymentId:
